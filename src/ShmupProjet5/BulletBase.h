...
public:
	...
	static BulletBase* InstantiateBullet(int damage, float speed, sf::Vector2f direction, sf::Vector2f position, float rotation, TextureName texture, Tag bulletTag, Stage* currentStage);
};
